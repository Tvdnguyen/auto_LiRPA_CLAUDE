...
from gtsrb_project.gtsrb_dataset import get_gtsrb_dataloaders
...
def main():
    ...
    parser.add_argument('--model', type=str, default='small', choices=['small'],
                       help='Model architecture (only small for this project)')
